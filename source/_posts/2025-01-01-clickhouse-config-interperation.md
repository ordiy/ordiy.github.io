---
title: clickhouse config xml 
excerpt: Clickhouse 24.x config.xml 配置说明
layout: post
...
# 自定义配置
自定义配置文件config.d/config.xml,（ 重写 config.xml 文件中的同element的value, 系统会自动刷新该配置文件，无需重启）
```xml
